// =============================================================================
//  Computer Graphics HW3 - Textured Cubes
//
...
{
    const char* prefixes[] = { "", "HW3_202111387/", "../HW3_202111387/", "../../HW3_202111387/" };
    FILE* file = NULL;
...
int main(void)
{
    ...
    window = glfwCreateWindow(1024, 768, "HW3 - Textured Cubes (202111387)", NULL, NULL);
    if (!window) {
    ...
    do {
        ...
        snprintf(title, sizeof(title),
                 "HW3 - Textured Cubes (202111387)  |  dist=%.1f  (wheel or Q/E to zoom)", gDist);
